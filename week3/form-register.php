        ...
        <form method="POST" action="form-register.php">
            ...
            <div class="form-group row">
                ...
                <div class="col-8">
                    ...
                    <div class="custom-control custom-checkbox custom-control-inline">
                        <input name="skills[]" id="skills[]_1" type="checkbox" class="custom-control-input"
                            value="css" />
                        <label for="skills[]_1" class="custom-control-label">CSS</label>
                    </div>
                    <div class="custom-control custom-checkbox custom-control-inline">
                        <input name="skills[]" id="skills[]_2" type="checkbox" class="custom-control-input"
                            value="js" />
                        <label for="skills[]_2" class="custom-control-label">JavaScript</label>
                    </div>
                    <div class="custom-control custom-checkbox custom-control-inline">
                        <input name="skills[]" id="skills[]_3" type="checkbox" class="custom-control-input"
                            value="bootstrap" />
                        <label for="skills[]_3" class="custom-control-label">Bootstrap</label>
                    </div>
                    <div class="custom-control custom-checkbox custom-control-inline">
                        <input name="skills[]" id="skills[]_4" type="checkbox" class="custom-control-input"
                            value="php" />
                        <label for="skills[]_4" class="custom-control-label">PHP</label>
                    </div>
                    <div class="custom-control custom-checkbox custom-control-inline">
                        <input name="skills[]" id="skills[]_5" type="checkbox" class="custom-control-input"
                            value="python" />
                        <label for="skills[]_5" class="custom-control-label">Python</label>
                    </div>
                    <div class="custom-control custom-checkbox custom-control-inline">
                        <input name="skills[]" id="skills[]_6" type="checkbox" class="custom-control-input"
                            value="java" />
...
<?php
// ambil data yang diimoputkan berdasarkan unik name
// isset berfungsi untuk memeriksa apakah suatu variabel sudah diisi & sudah diatur atau belum
